export const Aliases: import('../sim/dex').AliasesTable = {
    ...
    ledybaoriongold: "Ledyba-Orion",
    ledybaorionblue: "Ledyba-Orion",
    ledybaoriongreen: "Ledyba-Orion",
    ledybaorionpink: "Ledyba-Orion",
    ledybaorionsixth: "Ledyba-Orion",
    ledianoriongold: "Ledian-Orion",
    ledianorionblue: "Ledian-Orion",
    ledianoriongreen: "Ledian-Orion",
    ledianorionpink: "Ledian-Orion",
    ledianorionsixth: "Ledian-Orion",
    goomyorioncherry: "Goomy-Orion",
    sliggooorioncherry: "Sliggoo-Orion",
    goodraorioncherry: "Goodra-Orion",
    goomyorionbluerazz: "Goomy-Orion",
    sliggooorionbluerazz: "Sliggoo-Orion",
    goodraorionbluerazz: "Goodra-Orion",
    goomyorionlemon: "Goomy-Orion",
    sliggooorionlemon: "Sliggoo-Orion",
    goodraorionlemon: "Goodra-Orion",
    goomyorionorange: "Goomy-Orion",
    sliggooorionorange: "Sliggoo-Orion",
    goodraorionorange: "Goodra-Orion",
    goomyoriongrape: "Goomy-Orion",
    sliggoooriongrape: "Sliggoo-Orion",
    goodraoriongrape: "Goodra-Orion",
    meltanorionstrawberryvanilla: "Meltan-Orion",
    melmetalorionstrawberryvanilla: "Melmetal-Orion",
    meltanorionsaltedcaramel: "Meltan-Orion",
    melmetalorionsaltedcaramel: "Melmetal-Orion",
    meltanorionbananapeanutbutter: "Meltan-Orion",
    melmetalorionbananapeanutbutter: "Melmetal-Orion",
    squawkabillyoriongreen: "Squawkabilly-Orion",
    squawkabillyorionblue: "Squawkabilly-Orion",
    tatsugiriorionblue: "Tatsugiri-Orion",
    tatsugiriorionpink: "Tatsugiri-Orion",
	flabborion: "Flabébé-Orion",

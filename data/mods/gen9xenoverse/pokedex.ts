...
export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	...
	tyroguevintage: {
		...
		color: "Purple",
		eggGroups: ["Xenoverse"],
		evos: ["Hitmonlee-Vintage", "Hitmonchan-Vintage", "Hitmontop-Vintage", "Hitmontop-Vintage2"],
		tags: ["Xenoverse"],
		tier: "LC",
		natDexTier: "LC",
		doublesTier: "LC",
	...
	quilavaswap: {
		...
		weightkg: 19,
		color: "Yellow",
		prevo: "Cyndaquil-Swap",
		evoLevel: 14,
		evos: ["Typhlosion-Swap"],
		eggGroups: ["Xenoverse"],
		tier: "NFE",
		natDexTier: "NFE",
	},
...
export const cutDex = Object.fromEntries(Object.entries(Pokedex).map(([id, mon]) => [id, mon.num]));
...
for (const key in { ...Base, ...Pokedex }) {
	...
	if (cutDex[id]) {
		Pokedex[id] = { ...Pokedex[id], isNonstandard: null, gen: 9 };
		// Must allow for mega base forms
		if (Pokedex[id]?.baseSpecies) {
			let baseSpeciesID = Dex.species.get(Pokedex[id].baseSpecies).id
			Pokedex[baseSpeciesID] = { ...Pokedex[baseSpeciesID], isNonstandard: null, gen: 9 };
		}

...
export const Pokedex: ModdedSpeciesDataTable = {
	...
	braskeptic: {
		...
		name: "Braskeptic",
		types: ["Steel"],
		baseStats: { hp: 110, atk: 106, def: 100, spa: 106, spd: 109, spe: 69 },
	...
	caramitticrazed: {
		...
		types: ["Fairy", "Flying"],
		baseStats: { hp: 89, atk: 118, def: 25, spa: 131, spd: 62, spe: 140 },
	...
	magnemiteterof: {
		...
		types: ["Electric", "Grass"],
		baseStats: { hp: 55, atk: 35, def: 70, spa: 85, spd: 55, spe: 25 },
	...
	wallapillar: {
		...
		name: "Wallapillar",
		types: ["Bug", "Normal"],
		baseStats: { hp: 44, atk: 61, def: 72, spa: 33, spd: 52, spe: 38 },
		abilities: { 0: "Swarm", 1: "Shield Dust", H: "Friend Guard" },
		heightm: 0.3,
		weightkg: 22.2,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	bulwarva: {
		...
		name: "Bulwarva",
		types: ["Bug", "Normal"],
		baseStats: { hp: 62, atk: 73, def: 101, spa: 53, spd: 92, spe: 19 },
	...
	snowiibay: {
		...
		name: "Snowiibay",
		types: ["Flying", "Ghost"],
		baseStats: { hp: 115, atk: 57, def: 78, spa: 95, spd: 90, spe: 85 },
	...
	snugglosis: {
		...
		name: "Snugglosis",
		types: ["Dark", "Ground"],
		baseStats: { hp: 85, atk: 110, def: 75, spa: 65, spd: 125, spe: 30 },
	...
	twinova: {
		...
		name: "Twinova",
		types: ["Psychic", "Fairy"],
		baseStats: { hp: 90, atk: 52, def: 101, spa: 77, spd: 101, spe: 109 },
	...
	reneguana: {
		...
		baseStats: { hp: 80, atk: 110, def: 110, spa: 110, spd: 50, spe: 75 },
	...
	nebulant: {
		...
		abilities: { 0: "Vacuum Bubble", 1: "Telepathy", H: "Soundproof" },
		heightm: 1.4,
		weightkg: 28,
		gender: "N",
		tags: ["Pokeathlon"],
	...
	zorblob: {
		...
		baseForme: "Regular",
		types: ["Psychic"],
		baseStats: { hp: 90, atk: 65, def: 78, spa: 112, spd: 110, spe: 85 },
	...
	zorblobsplit: {
		...
		baseSpecies: "Zorblob",
		types: ["Psychic"],
		baseStats: { hp: 90, atk: 84, def: 66, spa: 122, spd: 66, spe: 112 },
		abilities: { 0: "Hive Mind" },
		heightm: 1.1,
		weightkg: 49.2,
		tags: ["Pokeathlon"],
	...
	whacksteroid: {
		...
		baseStats: { hp: 75, atk: 110, def: 105, spa: 65, spd: 85, spe: 85 },
	...
	cloudinyte: {
		...
		name: "Cloudinyte",
		types: ["Dark", "Flying"],
		baseStats: { hp: 79, atk: 105, def: 78, spa: 50, spd: 78, spe: 110 },
	...
	barreko: {
		...
		name: "Barreko",
		types: ["Grass", "Ground"],
		baseStats: { hp: 44, atk: 38, def: 55, spa: 38, spd: 55, spe: 20 },
		abilities: { 0: "Water Absorb", 1: "Damp", H: "Klutz" },
		heightm: 0.5,
		weightkg: 8,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
		evos: ["Cactusplash", "Dryguaro"],
		tier: "LC",
		natDexTier: "LC",
		doublesTier: "LC",
	},
	cactusplash: {
		...
		name: "Cactusplash",
		types: ["Grass", "Water"],
		baseStats: { hp: 92, atk: 53, def: 81, spa: 102, spd: 110, spe: 42 },
		abilities: { 0: "Storm Drain", 1: "Rain Dish", H: "Cannoneer" },
		heightm: 1.0,
		weightkg: 32,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	dryguaro: {
		...
		name: "Dryguaro",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 92, atk: 102, def: 110, spa: 53, spd: 81, spe: 42 },
		abilities: { 0: "Dry Skin", 1: "Sand Veil", H: "Sand Force" },
		heightm: 1.4,
		weightkg: 20,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	dryguaromega: {
		...
		name: "Dryguaro-Mega",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 92, atk: 132, def: 140, spa: 53, spd: 101, spe: 62 },
		...
		natDexTier: "OU",
		doublesTier: "DOU",
		baseSpecies: "Dryguaro",
		forme: "Mega",
		requiredItem: "Dryguaronite",
	},
	varkacosm: {
		num: 3129,
		name: "Varkacosm",
	...
	escarphone: {
		...
		name: "Escarphone",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 76, atk: 64, def: 140, spa: 90, spd: 82, spe: 46 },
		abilities: { 0: "Soul Symphony", 1: "Soundproof", H: "Own Tempo" },
		heightm: 0.7,
		weightkg: 48.3,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	potermit: {
		...
		name: "Potermit",
		types: ["Water"],
		baseStats: { hp: 64, atk: 51, def: 84, spa: 27, spd: 58, spe: 31 },
		abilities: { 0: "Weak Armor", H: "Rough Skin" },
		heightm: 0.5,
		weightkg: 8,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	ceraguard: {
		...
		baseStats: { hp: 101, atk: 109, def: 121, spa: 67, spd: 76, spe: 66 },
		abilities: { 0: "Shell Armor", 1: "Iron Fist", H: "Rough Skin" },
		heightm: 1.5,
		weightkg: 93,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	pixsilt: {
		...
		abilities: { 0: "Sturdy", 1: "No Guard", H: "Simple" },
		heightm: 0.9,
		weightkg: 18,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	utensitilemega: {
		num: 3135,
		name: "Utensitile-Mega",
		types: ["Steel", "Fire"],
		baseStats: { hp: 79, atk: 130, def: 125, spa: 50, spd: 136, spe: 75 },
		abilities: { 0: "Steam Engine" },
		heightm: 1.6,
		weightkg: 120,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
		baseSpecies: "Utensitile",
		forme: "Mega",
		requiredItem: "Utensitite",
		tier: "OU",
		natDexTier: "OU",
		doublesTier: "DOU",
	},
	utensitile: {
		...
		name: "Utensitile",
		types: ["Steel"],
		baseStats: { hp: 79, atk: 89, def: 90, spa: 51, spd: 131, spe: 55 },
	...
	arcaspark: {
		...
		baseStats: { hp: 100, atk: 95, def: 72, spa: 87, spd: 81, spe: 60 },
	...
	caskade: {
		...
		name: "Caskade",
		types: ["Fire", "Bug"],
		baseStats: { hp: 66, atk: 51, def: 53, spa: 90, spd: 64, spe: 45 },
		abilities: { 0: "Flash Fire", 1: "Shell Armor", H: "Infiltrator" },
		heightm: 0.3,
		weightkg: 63,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	catastropede: {
		...
		name: "Catastropede",
		types: ["Fire", "Dark"],
		baseStats: { hp: 132, atk: 91, def: 63, spa: 140, spd: 84, spe: 25 },
		abilities: { 0: "Flash Fire", 1: "Supreme Overlord", H: "Infiltrator" },
		heightm: 5,
		weightkg: 213,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	nweet: {
		...
		name: "Nweet",
		types: ["Fairy", "Normal"],
		baseStats: { hp: 57, atk: 75, def: 64, spa: 53, spd: 63, spe: 43 },
		abilities: { 0: "Guts", 1: "Battle Armor", H: "Justified" },
		heightm: 1,
		weightkg: 36,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	jawladin: {
		...
		name: "Jawladin",
		types: ["Fairy", "Normal"],
		baseStats: { hp: 115, atk: 97, def: 88, spa: 68, spd: 83, spe: 55 },
		abilities: { 0: "Guts", 1: "Battle Armor", H: "Justified" },
		heightm: 1,
		weightkg: 36,
		tags: ["Pokeathlon"],
	...
	rakura: {
		...
		name: "Rakura",
		types: ["Rock", "Grass"],
		baseStats: { hp: 99, atk: 54, def: 81, spa: 111, spd: 118, spe: 73 },
	...
	sauphozoa: {
		...
		name: "Sauphozoa",
		types: ["Psychic", "Poison"],
		baseStats: { hp: 103, atk: 77, def: 63, spa: 117, spd: 110, spe: 51 },
	...
	keepurr: {
		...
		abilities: { 0: "Frisk", 1: "Pickpocket", H: "Money Equals Power" },
		heightm: 1.03,
		weightkg: 17.6,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	verdicent: {
		...
		name: "Verdicent",
		types: ["Ice", "Dark"],
		baseStats: { hp: 70, atk: 109, def: 58, spa: 87, spd: 62, spe: 113 },
		abilities: { 0: "Dancer", 1: "Infiltrator", H: "Queenly Majesty" },
		heightm: 1.3,
		weightkg: 23.5,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	martiantis: {
		...
		abilities: { 0: "Mold Breaker", 1: "Scrappy", H: "Iron Fist" },
		heightm: 1.3,
		weightkg: 95.7,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	tenkibo: {
		...
		name: "Tenkibo",
		types: ["Normal"],
		baseStats: { hp: 70, atk: 45, def: 75, spa: 80, spd: 100, spe: 80 },
	...
	tenkibomagicalhero: {
		num: 3147,
		name: "Tenkibo-Magical-Hero",
		types: ["Normal", "Fairy"],
		baseStats: { hp: 70, atk: 85, def: 85, spa: 125, spd: 110, spe: 125 },
		abilities: { 0: "Natural Cure" },
		heightm: 1.1,
		weightkg: 24.7,
		tags: ["Pokeathlon"],
	...
	tadpuff: {
		...
		name: "Tadpuff",
		types: ["Fairy", "Flying"],
		baseStats: { hp: 50, atk: 25, def: 47, spa: 73, spd: 34, spe: 71 },
		abilities: { 0: "Anticipation", 1: "Wonder Skin", H: "Cloud Nine" },
		heightm: 0.2,
		weightkg: 0.3,
		evos: ["Soaribbit"],
		tags: ["Pokeathlon"],
	...
	soaribbit: {
		...
		name: "Soaribbit",
		types: ["Fairy", "Flying"],
		baseStats: { hp: 68, atk: 37, def: 70, spa: 75, spd: 60, spe: 80 },
		abilities: { 0: "Anticipation", 1: "Wonder Skin", H: "Cloud Nine" },
		heightm: 0.4,
		weightkg: 2.3,
		prevo: "Tadpuff",
	...
	slithereina: {
		...
		name: "Slithereina",
		types: ["Dark", "Poison"],
		baseStats: { hp: 77, atk: 79, def: 135, spa: 48, spd: 97, spe: 57 },
		abilities: { 0: "Strong Jaw", 1: "Intimidate", H: "Caecilian Defense" },
		heightm: 3.6,
		weightkg: 78.0,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	ignimask: {
		...
		name: "Ignimask",
		types: ["Fire"],
		baseStats: { hp: 21, atk: 42, def: 35, spa: 66, spd: 57, spe: 77 },
		abilities: { 0: "Blaze", H: "Aerilate" },
		heightm: 0.6,
		weightkg: 8.0,
		evos: ["Scavember"],
		tags: ["Pokeathlon"],
	...
	scavember: {
		...
		name: "Scavember",
		types: ["Fire"],
		baseStats: { hp: 44, atk: 49, def: 51, spa: 86, spd: 69, spe: 106 },
		abilities: { 0: "Blaze", H: "Aerilate" },
		heightm: 1.3,
		weightkg: 30.0,
		evos: ["Causticoon"],
	...
	causticoon: {
		...
		name: "Causticoon",
		types: ["Fire", "Flying"],
		baseStats: { hp: 78, atk: 74, def: 66, spa: 98, spd: 81, spe: 133 },
		abilities: { 0: "Blaze", H: "Aerilate" },
		heightm: 1.8,
		weightkg: 55.0,
		tags: ["Pokeathlon"],
	...
	eversheen: {
		...
		name: "Eversheen",
		types: ["Ice", "Grass"],
		baseStats: { hp: 97, atk: 59, def: 135, spa: 121, spd: 86, spe: 35 },
	...
	hyterra: {
		...
		name: "Hyterra",
		types: ["Dragon", "Ground"],
		baseStats: { hp: 80, atk: 82, def: 90, spa: 113, spd: 105, spe: 55 },
		abilities: { 0: "Sand Spit", 1: "Immunity", H: "Dry Skin" },
		heightm: 2.2,
		weightkg: 171,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	grascylle: {
		...
		name: "Grascylle",
		types: ["Poison", "Dragon"],
		baseStats: { hp: 69, atk: 63, def: 74, spa: 123, spd: 91, spe: 103 },
		abilities: { 0: "Flower Veil", 1: "Competitive", H: "Magic Bounce" },
		heightm: 1.6,
		weightkg: 42,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	mallowhim: {
		...
		name: "Mallowhim",
		types: ["Normal", "Flying"],
		baseStats: { hp: 97, atk: 65, def: 106, spa: 106, spd: 77, spe: 79 },
		abilities: { 0: "Weak Armor", 1: "Gooey", H: "Flare Boost" },
		heightm: 0.4,
		weightkg: 6,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	conchallenge: {
		...
		baseStats: { hp: 54, atk: 105, def: 136, spa: 50, spd: 72, spe: 68 },
		abilities: { 0: "Shell Armor", 1: "Sheer Force", H: "Dry Skin" },
		heightm: 1.17,
		weightkg: 72.6,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	mochaselle: {
		...
		name: "Mochaselle",
		types: ["Water", "Fire"],
		baseStats: { hp: 65, atk: 48, def: 80, spa: 112, spd: 132, spe: 88 },
		abilities: { 0: "Insomnia", 1: "Flame Body", H: "Concentrate" },
		heightm: 0.4,
		weightkg: 1.6,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	vervestra: {
		...
		name: "Vervestra",
		types: ["Grass", "Dragon"],
		baseStats: { hp: 51, atk: 109, def: 65, spa: 52, spd: 73, spe: 113 },
		abilities: { 0: "Harvest", 1: "Defiant", H: "Skill Link" },
		heightm: 2.4,
		weightkg: 72.6,
		tags: ["Pokeathlon"],
		eggGroups: ["Pokeathlon", "POA"],
	...
	hederlix: {
		...
		abilities: { 0: "Leaf Guard", H: "Sap Sipper" },
		heightm: 2.4,
		weightkg: 123.1,
		color: "Green",
		tags: ["Pokeathlon"],
	...
	karajolt: {
		...
		abilities: { 0: "Wandering Spirit", H: "Natural Cure" },
		heightm: 1.3,
		weightkg: 45.2,
		color: "Black",
		tags: ["Pokeathlon"],

export const Moves: {[k: string]: ModdedMoveData} = {
	...
	expunge: {
		...
		shortDesc: "Super effective on Nuclear. 100% acc in rain.",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
		onModifyMove(move, pokemon, target) {
	...
	subduction: {
		...
		category: "Physical",
		name: "Subduction",
		desc: "Has a 100% chance to lower the user's Speed by 2 stages and confuse it.",
		shortDesc: "Lowers user's Speed by 2 and confuses it.",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
		self: {

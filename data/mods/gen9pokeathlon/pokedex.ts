...
// Vanilla modifications
	...
	lunachi: {
		...
		name: "Lunachi",
		types: ["Fairy", "Dark"],
		baseStats: {hp: 108, atk: 87, def: 82, spa: 87, spd: 72, spe: 114},
		abilities: {0: "Sacred Treasures", 1: "Trace"},
		heightm: 0.3,
		weightkg: 11,
		color: "White",
		tags: ["Pokeathlon"],
	...
	scaleslash: {
		...
		abilities: {0: "Sand Force", 1:"Belligerent Quills"},
		heightm: 1.5,
		weightkg: 110,
		color: "Purple",
		prevo: "Sandslash",

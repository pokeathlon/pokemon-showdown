...
export const Moves: {[moveid: string]: MoveData} = {
	...
	starburst: { // Type changes depending on starter 
		num: 0, 
		type: FAIRY, 
		accuracy: 90, 
		basePower: 130, 
	...
	xtransform: { 
		...
		pp: 10, 
		priority: 0, 
		flags: ""Chi la usa si trasforma in una copia esatta di una specie X casuale."",
		target: 0, 
		secondary:205
	},
	acidrain: { 
	...
	dragonendurance: { 
		...
		basePower: 0, 
		category: Status, 
		name: DRAGONENDURANCE, 
		pp: 15, 
		priority: 0, 
		flags: "Chi la usa crea uno scudo che indebolisce per cinque turni le mosse di tipo Elettro, Fuoco, Herba e Acqua"
		target: 20, 
		secondary:301
	},
	velvetscales: { 
	...
	magicwall: { 
		...
		pp: 15, 
		priority: 0, 
		flags: "Chi la usa crea un muro che indebolisce per cinque turni le mosse di tipo Drago, Lotta, Buio e Coleottero",
		target: 20, 
		secondary:307
	},
	soundbarrier: { 
		...
		pp: 15, 
		priority: 0, 
		flags: "Chi la usa crea un muro che indebolisce per cinque turni le mosse di tipo Volante, Acqua, Fata",
		target: 20, 
		secondary:308
	},
	flavortest: { //heals + adds ice type to type effectiveness
		num: 0, 
		type: FAIRY, 
		accuracy: 100, 
		basePower: 100, 
	...
	divinejudgement: { 
		...
		pp: 10, 
		priority: 0, 
		flags: "Due turni dopo l'utilizzo di questa mossa",
		target: 0, 
		secondary:111
	},
	elepunch: { // Type depends on held weather stone 
		num: 0, 
		type: NORMAL, 
		accuracy: 100, 
		basePower: 85, 

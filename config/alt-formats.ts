export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'pokemon:mewtwoarmor', 'Mewtwo-Mega-X', 'Mewtwo-Mega-Y', 'Mewtwo-Shadow', 'Mewtwo-Shadow-Mega-X', 'Miraidon', 'Naganadel', 'Necturna', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane', 'Nucleon', 'Oblivicorn-Mega', 'Ockthane', 'Oculeus', 'Ogerpon-Hearthflame', 'Ogerpon-Wellspring', 'Omnimon', 
			...
			'Solgaleo', 'Sonic', 'Tapu Koko', 'Tapu Lele', 'Terapagos', 'UFI', 'Ursaluna-Bloodmoon', 'Urshifu', 'Vareon', 'Volcarona-Delta', 'pokemon:volcaronadeltaarmored', 'WarGreymon', 'Xerneas', 'Xurkitree', 'Yatagaryu', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Crowned', 'Zekrom', 
			'pokemon:zekromarmor', 'Zekyushiram', 'Zygarde', 'Zygarde-Complete',

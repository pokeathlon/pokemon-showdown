export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Solgaleo', 'Sonic', 'Tapu Koko', 'Tapu Lele', 'Terapagos', 'UFI', 'Ursaluna-Bloodmoon', 'Urshifu', 'Vareon', 'Volcarona-Delta', 'pokemon:volcaronadeltaarmor', 'WarGreymon', 'Xerneas', 'Xurkitree', 'Yatagaryu', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Crowned', 'Zekrom', 

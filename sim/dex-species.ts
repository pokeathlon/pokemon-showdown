...
type SpeciesTag = "Mythical" | "Restricted Legendary" | "Sub-Legendary" | "Ultra Beast" | "Paradox" | "Infinite Fusion" | "Pokeathlon" | "Insurgence" | "Uranium" | "Infinity" | "Mariomon" | "Rejuvenation";
...
export class Species extends BasicEffect implements Readonly<BasicEffect & SpeciesFormatsData> {
	...
	constructor(data: AnyObject) {
		...
		this.isMega = !!(this.forme && ['Mega', 'Mega-X', 'Mega-Y', 'Mega-M', 'Mega-F', 'Crystal'].includes(this.forme)) || undefined;
